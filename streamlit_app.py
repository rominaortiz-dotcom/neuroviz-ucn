...
<style>
    ...
    .page-sub     { font-size:0.95rem; color:#4F5E80; margin-top:0.2rem; margin-bottom:0; }
    ...
    .tag-low      { background:#BF7330; color:#1A1A1A; border-radius:4px; padding:2px 8px; font-size:0.8rem; }
    .tag-med      { background:#8F9FBF; color:#0D0D0D; border-radius:4px; padding:2px 8px; font-size:0.8rem; }
    ...
    div[data-testid="stMetricLabel"]  { font-size:0.78rem !important; color:#4F5E80 !important; }
...
if "Inicio" in seccion:
    ...
    with col1:
        ...
        <div class="card">
            ...
            <p style="font-size:0.85rem; color:#4F5E80; margin-bottom:0;">
    ...
    with col3:
        ...
        <div class="card" style="border-left:4px solid #8F9FBF; min-height:160px;">
            <h2 style="color:#4F5E80; margin-top:0; font-size:2rem;">03</h2>
            <p style="font-size:0.88rem; color:#444; line-height:1.5; margin-bottom:0;">
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with tab1:
        ...
        with col_a:
            ...
            <div class="card" style="border-left:4px solid #0511F2;">
                ...
                <table style="width:100%; font-size:0.85rem;">
                    <tr style="color:#4F5E80; font-size:0.75rem;"><td><b>#</b></td><td><b>Estímulo</b></td><td><b>Frec.</b></td><td><b>✓ Único CA</b></td></tr>
                    <tr><td>1</td><td>MÉDICO</td><td>59</td><td>✓</td></tr>
                    <tr style="background:#F5F5F5;"><td>2</td><td>EMPRESARIO</td><td>40</td><td>✓</td></tr>
                    <tr><td>3</td><td><s style="color:#666666;">INGENIERO</s></td><td><span style="color:#666666;">38</span></td><td><span style="color:#8C5424;">✗ en CM</span></td></tr>
                ...
                <p style="font-size:0.75rem; color:#4F5E80; margin:0.5rem 0 0 0;">
        ...
        with col_b:
            ...
            <div class="card" style="border-left:4px solid #BF7330;">
                ...
                <table style="width:100%; font-size:0.85rem;">
                    <tr style="color:#4F5E80; font-size:0.75rem;"><td><b>#</b></td><td><b>Estímulo</b></td><td><b>Frec.</b></td><td><b>✓ Único CB</b></td></tr>
                    ...
                    <tr style="background:#F5F5F5;"><td>4</td><td><s style="color:#666666;">VENDEDOR</s></td><td><span style="color:#666666;">19</span></td><td><span style="color:#8C5424;">✗ en CM</span></td></tr>
    ...
    with tab2:
        ...
        with col2:
            ...
            <div class="card" style="margin-top:20px;">
                ...
                <p style="font-size:0.8rem; color:#4F5E80;">
    ...
    with tab1:
        ...
        st.dataframe(resumen_grupo, width='stretch')
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with tab2:
        ...
        st.dataframe(resumen_sub, width='stretch', hide_index=True)
